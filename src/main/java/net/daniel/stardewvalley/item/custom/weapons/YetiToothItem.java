...
public class YetiToothItem extends SwordItem {

    public YetiToothItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
