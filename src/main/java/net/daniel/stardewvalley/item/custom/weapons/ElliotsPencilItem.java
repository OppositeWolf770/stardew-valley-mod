...
public class ElliotsPencilItem extends SwordItem {

    public ElliotsPencilItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
