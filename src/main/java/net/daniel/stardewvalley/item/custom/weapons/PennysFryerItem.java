...
public class PennysFryerItem extends SwordItem {

    public PennysFryerItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
