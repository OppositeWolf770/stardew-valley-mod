...
public class ArtifactAnchorItem extends Item {
    public ArtifactAnchorItem(Properties pProperties) {
        super(pProperties);
    }
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        if(Screen.hasShiftDown()) {
            pTooltipComponents.add(Component.literal
                    ("It may have belonged to ancient pirates.").withStyle(StardewValley.tooltipColor)
            );
        } else {
