...
public class BurglarsShankItem extends SwordItem {

    public BurglarsShankItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
