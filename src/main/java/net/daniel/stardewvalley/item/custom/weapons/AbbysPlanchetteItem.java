...
public class AbbysPlanchetteItem extends SwordItem {

    public AbbysPlanchetteItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
