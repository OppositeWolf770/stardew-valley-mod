...
public class TemperedBroadswordItem extends SwordItem {

    public TemperedBroadswordItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
