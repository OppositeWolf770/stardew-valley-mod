...
public class GalaxySwordItem extends SwordItem {

    public GalaxySwordItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
