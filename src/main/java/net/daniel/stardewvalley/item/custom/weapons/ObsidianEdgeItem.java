...
public class ObsidianEdgeItem extends SwordItem {

    public ObsidianEdgeItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
