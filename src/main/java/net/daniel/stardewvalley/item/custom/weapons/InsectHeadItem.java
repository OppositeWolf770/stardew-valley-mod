...
public class InsectHeadItem extends SwordItem {

    public InsectHeadItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
