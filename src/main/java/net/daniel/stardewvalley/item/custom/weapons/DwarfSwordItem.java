...
public class DwarfSwordItem extends SwordItem {

    public DwarfSwordItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
