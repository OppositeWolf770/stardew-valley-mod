...
public class OssifiedBladeItem extends SwordItem {

    public OssifiedBladeItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
