...
public class WindSpireItem extends SwordItem {

    public WindSpireItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
