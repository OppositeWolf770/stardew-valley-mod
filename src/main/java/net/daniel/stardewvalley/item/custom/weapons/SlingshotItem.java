...
public class SlingshotItem extends SwordItem {

    public SlingshotItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
