...
public class LavaKatanaItem extends SwordItem {

    public LavaKatanaItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
