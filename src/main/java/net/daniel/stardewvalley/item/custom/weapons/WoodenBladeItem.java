...
public class WoodenBladeItem extends SwordItem {

    public WoodenBladeItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
