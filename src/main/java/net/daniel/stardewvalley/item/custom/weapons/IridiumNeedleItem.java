...
public class IridiumNeedleItem extends SwordItem {

    public IridiumNeedleItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
