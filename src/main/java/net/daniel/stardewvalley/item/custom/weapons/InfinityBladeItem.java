...
public class InfinityBladeItem extends SwordItem {

    public InfinityBladeItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
