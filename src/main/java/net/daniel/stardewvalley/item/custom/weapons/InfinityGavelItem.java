...
public class InfinityGavelItem extends SwordItem {

    public InfinityGavelItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
