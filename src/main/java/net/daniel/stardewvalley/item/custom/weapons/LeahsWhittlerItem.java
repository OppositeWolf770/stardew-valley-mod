...
public class LeahsWhittlerItem extends SwordItem {

    public LeahsWhittlerItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
