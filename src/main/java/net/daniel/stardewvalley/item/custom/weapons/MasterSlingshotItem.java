...
public class MasterSlingshotItem extends SwordItem {

    public MasterSlingshotItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
