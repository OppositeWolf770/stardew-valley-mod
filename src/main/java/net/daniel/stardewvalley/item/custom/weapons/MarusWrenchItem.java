...
public class MarusWrenchItem extends SwordItem {

    public MarusWrenchItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
