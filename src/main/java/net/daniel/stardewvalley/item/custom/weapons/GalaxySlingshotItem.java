...
public class GalaxySlingshotItem extends SwordItem {

    public GalaxySlingshotItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
