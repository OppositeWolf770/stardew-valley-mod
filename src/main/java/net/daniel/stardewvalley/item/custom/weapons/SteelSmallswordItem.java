...
public class SteelSmallswordItem extends SwordItem {

    public SteelSmallswordItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
