...
public class HarveysMalletItem extends SwordItem {

    public HarveysMalletItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
