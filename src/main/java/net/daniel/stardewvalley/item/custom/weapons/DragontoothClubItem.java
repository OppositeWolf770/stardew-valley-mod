...
public class DragontoothClubItem extends SwordItem {

    public DragontoothClubItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
