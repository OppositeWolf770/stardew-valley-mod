...
public class DwarfHammerItem extends SwordItem {

    public DwarfHammerItem(Tier pTier, int pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
