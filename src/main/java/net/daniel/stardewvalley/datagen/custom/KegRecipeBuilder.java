...
import net.daniel.stardewvalley.recipe.KegRecipe;
...
public class KegRecipeBuilder implements RecipeBuilder {
    ...
    public KegRecipeBuilder(ItemLike ingredient, ItemLike result, int count) {
    ...
    public static class Result implements FinishedRecipe {
        ...
        public ResourceLocation getId() {
            return new ResourceLocation(StardewValley.MOD_ID,
                    ForgeRegistries.ITEMS.getKey(this.result).getPath() + "_from_keg");
        }
